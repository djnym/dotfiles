...
# I originally found this file here
#   http://www.macosxhints.com/dlfiles/preexec.bash.txt
# which references
#   http://www.twistedmatrix.com/users/glyph/preexec.bash.txt
# as the original in this article
#   http://www.macosxhints.com/article.php?story=20071009124425468
# I edited to remove the xterm stuff that existed just to keep my
# environment slightly cleaner
